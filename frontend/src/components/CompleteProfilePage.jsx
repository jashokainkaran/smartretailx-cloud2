  ...
  return (
    <section className="mx-auto max-w-md py-8">
      <motion.div
        ...
        className="rounded-2xl bg-white p-6 shadow-luxe sm:p-8"
      >
        <p className="text-sm font-semibold text-brand-700">One last step</p>
        <h2 className="mt-2 font-serif text-3xl font-medium tracking-tight text-stone-900">Complete your profile</h2>
        ...
        <form className="mt-7 space-y-5" onSubmit={submit} noValidate>
          ...
          <button
            disabled={saving}
            className="w-full rounded-full bg-brand-600 px-4 py-3 text-sm font-semibold text-white shadow-luxe-sm transition hover:-translate-y-0.5 hover:bg-brand-700 active:translate-y-0 disabled:translate-y-0 disabled:opacity-60"
          >
  ...
  return (
    <label className="block text-sm font-semibold text-stone-800">
      ...
      <input
        ...
        className="mt-1.5 w-full rounded-lg border border-stone-300 px-3 py-2.5 transition focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-200"
      />
    </label>
  );
}
