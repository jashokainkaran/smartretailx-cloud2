...
# Matches test_products.py: config.py reads these once at import time, and
# pytest collects files alphabetically ("test_auth" before "test_products"),
# so this file must set them too or it freezes app.config against the real
# (unset) environment before test_products.py's own assignments ever run.
