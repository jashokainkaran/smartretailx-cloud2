...
# Matches test_inventory.py: config.py reads these once at import time, and
# pytest collects files alphabetically ("test_auth" before "test_inventory"),
# so this file must set them too or it freezes app.config against the real
# (unset) environment before test_inventory.py's own assignments ever run.
