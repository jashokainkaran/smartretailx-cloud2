...
# Matches test_payments.py: config.py reads these once at import time, and
# pytest collects files alphabetically ("test_auth" before "test_payments"),
# so this file must set them too or it freezes app.config against the real
# (unset) environment before test_payments.py's own assignments ever run.
